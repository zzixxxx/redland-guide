...
- [ ] IP 官方账号：81 个展位已关联 21 个（9/11 用户补 6 个预告链接：A01a/A01b/A02/A03a/A03b/A05），其余 60 个等用户逐个分享笔记 / 主页链接再补；自动查询已验证不可行（§9）
...
- [ ] 其余 IP 的展台详情（已收录 A06 星布谷地、A09 星穹铁道、A21 三丽鸥、A22 火影忍者、A24 SCLA / 新创华、A25 Aniplex、A34 我的世界、A35 阅文、B01 蛋仔派对、B02 / C16 宝可梦、B04a 永劫无间、B16 宝藏码头、B18 火影忍者手游、B22 冰品补给点）
