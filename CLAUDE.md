...
- [ ] IP 官方账号：93 个展位行已关联 75 个（9/11 用户六批共 112 条链接；93 = 原 81 + 平面图新增 12 行），剩 13 行待补：A31 MOTORSLICE / SILLY POLLY BEAST、A37 动物城模拟生活新游（Partopia）、B19 CLUTCH、C04 独立游戏试玩区（无单一账号；各摊位账号进 `boothDetails.C04.accounts`，已有救世阿姨 = 陆生海胆LandUni）、C13 GSE、A04 / A26 / B20（待解锁，无 IP）、A07 京东101HOME、B21c 中国银联 / B21d 华硕 a豆、C19 高达汇战、C20 符文战场。9/20 再补 B21a 康师傅冰红茶（id 已与华硕 a豆 对调）。9/20 补 4 个：A16 光夜展陈（用户确认与 A40 光与夜之恋是同一 IP，挂光与夜之恋官方号）、B21b Danisa 皇冠丹麦曲奇、C10 FINAL FANTASY RESONANCE（SQUARE ENIX ASIA 9/15 为登岛开的号，此前填过的「最终幻想14」不是同一游戏）、C11 MARD；自动查询已验证不可行（§9）。独立游戏 84 款已有账号 41 个（9/14 补 Rain 98；505 Games / Mecrew games / UBISOFT 一个账号对应多款）
...
- [ ] A17b 归环：「PIN 卡」已按官方卡片原图进 `pins.js`（`A17b-1` / `A17b-2`），但**是否算冒险者拼图用的区域 PIN 仍待确认** —— 官方没给软盘造型的成品图，也没说能不能拿去结算点换拼图；女仆迎宾名单与场次、花车巡礼出场角色待公布
- [ ] A08 代号如意：三段行动（特别调查 / 心动频率特别联络 / 探员之星嘉奖夜）的玩法、时段、是否需预约与奖品全部待公布
- [ ] A40 光与夜之恋：9/21 只发了预约说明 —— 【窗畔花影】【绮梦花园】的具体玩法与**着装要求**、【无料领取】要完成的**打卡任务**、无料款式（是否有 PIN）都还没公布，官方写「详见展台活动部分的说明」，等第二条笔记
...
- [ ] 花车巡游时间两套口径：官方「花车巡礼」半层写 17:30 – 18:00，命运扳机 / 星布谷地 / 重返未来：1999 / 绝区零 / 光与夜之恋 五家 IP 自己的笔记都写 17:00 – 17:30，已在 `paradeInfo.disclaimer` 里说明，10 月前看官方是否统一
...
- [ ] A28 代号：香：**调香活动 9/20 已公布**（每日 14 轮、每场 30 分钟、需预约）；「角色互动」的预约规则仍待公布；无料领取的伸手礼与小卡样式未公布
