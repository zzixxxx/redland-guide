...
- [x] 展位活动预约：RED LAND 官方号 9/19「展位活动预约指南」已接入（`rules.js booking` + `public/img/rules/booking/`，首页折叠卡）。**9/25 预约系统上线并公布全部预约活动与时间表 → 9/28–9/30 开放预约 → 10/2–10/6 现场动态二维码核销**，线下每日 12:30 开放入场。9/25 当天要回来补各展位的具体预约场次 / 名额
...
- [ ] IP 官方账号：93 个展位行已关联 75 个（9/11 用户六批共 112 条链接；93 = 原 81 + 平面图新增 12 行），剩 14 行待补：A31 MOTORSLICE / SILLY POLLY BEAST、A37 动物城模拟生活新游（Partopia）、B19 CLUTCH、C04 独立游戏试玩区（无单一账号）、C13 GSE、A04 / A26 / B20（待解锁，无 IP）、A07 京东101HOME、B21a 华硕 a豆 / B21c 中国银联 / B21d 康师傅冰红茶、C19 高达汇战、C20 符文战场。9/20 补 4 个：A16 光夜展陈（用户确认与 A40 光与夜之恋是同一 IP，挂光与夜之恋官方号）、B21b Danisa 皇冠丹麦曲奇、C10 FINAL FANTASY RESONANCE（SQUARE ENIX ASIA 9/15 为登岛开的号，此前填过的「最终幻想14」不是同一游戏）、C11 MARD；自动查询已验证不可行（§9）。独立游戏 84 款已有账号 41 个（9/14 补 Rain 98；505 Games / Mecrew games / UBISOFT 一个账号对应多款）
...
- [ ] 花车巡游时间两套口径：官方「花车巡礼」半层写 17:30 – 18:00，命运扳机 / 星布谷地 / 重返未来：1999 / 绝区零 四家 IP 自己的笔记都写 17:00 – 17:30，已在 `paradeInfo.disclaimer` 里说明，10 月前看官方是否统一
...
- [ ] A35 阅文：道诡异仙「阅文小伙伴集结 PIN 卡」（9/17 定名）是否为冒险者拼图 PIN 待确认（确认后补进 `pins.js`）；狐妖小红娘集章话题、阅文好物无料详情、王也生日会礼赠均「待公布」，专题页 `endTime` 10/12，10 月前重抓 diff；6 个 IP 账号昵称未核实（用栏目名代替）
