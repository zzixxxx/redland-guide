...
- [ ] IP 官方账号：81 个展位已关联 34 个（9/11 用户两批共 28 条链接补了 19 个展位 + 5 个独立游戏账号），其余 47 个等用户逐个分享笔记 / 主页链接再补；自动查询已验证不可行（§9）。独立游戏 84 款已有账号 5 个
...
- [ ] 其余 IP 的展台详情（已收录 A06 星布谷地、A09 星穹铁道、A21 三丽鸥、A22 火影忍者、A24 SCLA / 新创华、A25 Aniplex、A34 我的世界、A35 阅文、B01 蛋仔派对、B02 / C16 宝可梦、B04a 永劫无间、B04b 暴雪游戏、B16 宝藏码头、B18 火影忍者手游、B22 冰品补给点、A19 黑神话、A39 粒粒的小人国、C14 声探疑云）
