...
// 首页卡片：00 全图占满一行（横图很宽），01 / 02 / 03 三区一行，04 图例单独一格（用户 9/11 定的排法）。
...
export const venueMap = {
  ...
  images: [
    ...
    { src: 'img/rules/map-2026/01.jpg', alt: 'A 区 翻身时空港 + 东侧与南侧：A-01 ~ A-40 展位分布、入口 / 出口、安检票检、寄存处、装备区、蓄客等待区、地铁 12 号线复兴岛站、577 中华船厂站与日间接驳车上下车点' },
