...
export const booths = [
  ...
  { id: 'B06', zone: 'B', no: 'B06', ip: '无畏契约端手游', alias: 'VALORANT 源能行动', blurb: '瓦搭市集嗨翻天，舞台 PK 不设限，喊上搭子，尽兴开逛！' },
  ...
  { id: 'C02', zone: 'C', no: 'C02', ip: '灰烬之国 Cinderia', blurb: '童话世界沾染灰烬，你我一同改写宿命' },
  ...
  { id: 'C06', zone: 'C', no: 'C06', ip: 'Servant of the Lake 湖之仆从', alias: '湖之仆从 VANDERBOOM', blurb: 'VANDERBOOM 宅邸的铁门已然推开——欢迎就任，湖之仆从' },
  ...
  { id: 'C15', zone: 'C', no: 'C15', ip: '拉瑞安工作室', alias: '神界 神界原罪2 Larian', blurb: '闯入地图外的阿克斯市集，开启一场奇货冒险' },
