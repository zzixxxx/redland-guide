...
export const pins = [
  ...
  { id: 'A25-1', no: 'A25-1', type: 'region', zone: 'A', name: 'ANIPLEX「存档碎片」· 日场款（橙）', booth: 'A25b', how: '限定特典第二弹：Aniplex 展台内拍照打卡，带 #国庆节在ANIPLEX展台当牛马 投稿小红书后随孤独摇滚福袋发放', thumb: 'img/pins/A25-1.jpg', image: 'img/booths/A25/second-00.jpg' },
  { id: 'A25-2', no: 'A25-2', type: 'region', zone: 'A', name: 'ANIPLEX「存档碎片」· 夜场款（黑绿）', booth: 'A25b', how: '限定特典第二弹：与日场款为两款不同设计，同随孤独摇滚福袋发放', thumb: 'img/pins/A25-2.jpg', image: 'img/booths/A25/second-00.jpg' },
