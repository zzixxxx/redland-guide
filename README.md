...
| Tab | 内容 |
|---|---|
| 展位攻略 | 每日时刻表 · 主线玩法（PIN 分区分色 / 区域开图 / 冒险者拼图）· 官方场馆平面图（三区展位编号 / 路线图例 / 交通与回血点位 / 功能点位指南）· A/B/C 区（翻身时空港 / 黄金海岸线 / 重生试炼场）IP 展位一览 · 点击展位看展台活动 / 舞台活动 / 展台任务 / 奖励 · 一键跳转 IP 小红书主页核对最新动态 · 本机打卡进度 |
